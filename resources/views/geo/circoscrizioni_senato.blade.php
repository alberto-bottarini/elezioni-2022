...
@section('content')
    <h1 class="text-2xl mb-2">Elenco Circoscrizioni Senato</h1>
    ...
    <table class="w-full text-sm">
        ...
        @foreach($circoscrizioni as $circoscrizione)
            <tr class="even:bg-slate-100 odd:bg-slate-200">
                <td class="p-1"><a href="{{ route('circoscrizione_senato', $circoscrizione) }}" class="anchor">{{ $circoscrizione->nome }}</a></td>
